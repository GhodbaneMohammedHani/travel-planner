...
export default function TripDetailClient({trip}: TripDetailClientProps){
    ...
    return <div className="container mx-auto px-4 py-8 space-y-8">
        {trip.imageUrl && <div className="w-full h-72 md:h-96 overflow-hidden rounded-xl shadow-lg relative">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">{trip.startDate.toLocaleDateString()} - {trip.endDate.toLocaleDateString()}
                                     <br /> {`${Math.round((trip.endDate.getTime()- trip.startDate.getTime())/ (1000*60*60*24))} days`}
                                     </p>
                                </div>
                            </div>
                            <div className="flex items-start">
